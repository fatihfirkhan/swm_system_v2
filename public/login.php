            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="backend/handle_login.php?role=<?php echo $role; ?>"
                            id="loginForm">
                            ...
                            <?php else: ?>
                                <div class="form-group">
                                    <input type="text" name="work_id" class="form-control form-control-user"
                                        placeholder="Enter Work ID" required>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="password" name="password"
                                        class="form-control form-control-user <?php echo ($error === 'wrong_password') ? 'is-invalid' : ''; ?>"
