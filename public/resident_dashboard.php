            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <small class="text-muted">Welcome back, <?php echo htmlspecialchars($resident['name']); ?>!</small>
                    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <?php else: ?>
                                <div class="alert alert-info shadow">
                                    ...
                                    <strong>No upcoming collections scheduled.</strong> Please check back later or contact support.
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php if (isset($resident['lane_name'])): ?>
                                                <small class="text-muted"><?php echo htmlspecialchars($resident['lane_name']); ?></small>
                                            <?php endif; ?>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <small class="text-muted"><?php echo $totalComplaints - $pendingComplaints; ?> Resolved</small>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <a href="resident_complaints.php" class="btn btn-primary btn-block quick-action-btn">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <a href="resident_schedule.php" class="btn btn-outline-primary btn-block quick-action-btn">
                            ...
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-warning mb-0">
                                        ...
                                        <strong>Need Help?</strong> Contact: 1-800-SWM-HELP
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo date('M d, Y', strtotime($comp['submission_time'])); ?></td>
                                                    <td><?php echo htmlspecialchars(substr($comp['description'], 0, 50)) . (strlen($comp['description']) > 50 ? '...' : ''); ?></td>
                                                    <td>
                                                        <?php 
                                                        $badgeClass = 'badge-warning';
                                                        if ($comp['status'] === 'Resolved') $badgeClass = 'badge-success';
                                                        elseif ($comp['status'] === 'In Progress') $badgeClass = 'badge-info';
                                                        ?>
                                                    ...
                                                    <td>
                                                        <a href="resident_complaints.php" class="btn btn-sm btn-outline-primary">
