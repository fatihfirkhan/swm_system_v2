...
// Check if user is logged in as ADMIN only
...
<style>
/* Custom dark green theme matching sidebar */
.bg-swm-dark {
    background: linear-gradient(180deg, #0f6848 10%, #0d5539 100%) !important;
...
.btn-swm-dark:focus,
.btn-swm-dark:active {
    background-color: #0d5539 !important;
    border-color: #0d5539 !important;
    color: white !important;
}

.border-left-swm-dark {
    border-left: 0.25rem solid #0f6848 !important;
}
</style>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-user-shield text-swm-dark"></i> Admin Profile
        </h1>
    </div>
